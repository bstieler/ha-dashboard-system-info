...
Custom-component workaround for HA Core issue where the binary sensor's
update() method is called before the UnderVoltage client is initialized.
This override adds a null-check in the update path and keeps the entity
